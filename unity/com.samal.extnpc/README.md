<h1 align="center">SAMARA World Viewer</h1>

<p align="center"><em>Reads a world bundle exported by the SAMARA
engine, and shows it.</em></p>

<p align="center">
  <img alt="unity" src="https://img.shields.io/badge/unity-6000.0%2B-4ea3ff">
  <img alt="tests" src="https://img.shields.io/badge/EditMode%20tests-122%20passing-0ca30c">
...
- **Inter-tick motion is cosmetic, and says so on screen** while it is
  ...
  because a villager's map position is
  `deme centre + person_map_offset(name)`,
...
things a chart cannot show. Neither reimplements the other; both read the
same
