...
| **2** — structural realism | 2, 3, 4, 5, 6, 11 done · 12 partial · **13, 14 open** | in progress |
| **3** — algorithms + validation | 29, 30, 32 done · **31 partial** | in progress |

**Open:** #13 developmental trajectory (life-stage gating of expression), #14
canalization (the reaction norm is in, Waddington buffering is not), #31
